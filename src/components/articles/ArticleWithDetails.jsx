...
import { faFlag, faEnvelope } from '@fortawesome/free-solid-svg-icons';
    ...
    <React.Fragment>
      <div className="d-flex align-items-center justify-content">
        ...
        <div className="card mb-3 article animated">
          ...
          <NavLink to={`${article.slug}/report`} article={article}>
            <FontAwesomeIcon
              icon={faFlag}
              size="2x"
              onClick={localStorage.setItem('slug', article.slug)}
